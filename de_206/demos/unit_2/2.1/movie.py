...
class ODEFamilySweep(Scene):
    def construct(self):
        ...
        ).to_edge(DOWN).shift(LEFT * 1.4)   # Moderate left shift
        ...
        # Seed family
        seeds = [0, 1, 2, 3, 4]  # Restrict seeds for current ymax
        ...
        slider_track.to_corner(UP + RIGHT).shift(DOWN * 0.5)  # Top-right
        ...
        # LEGEND (key): shifted down, yellow line for selected
...
# IPython widget helpers for Jupyter
